...
learning_rate = 1.0
# Standard
def _run_standard_algorithm(learning_rate):
    """
...
def _run_voted_algorithm(learning_rate):
    """
...
def _run_average_algorithm(learning_rate):
    """
...
def _import_data(path, num_examples):
    ...
    data = normalize(np.asarray(data), axis=0)
...
if __name__ == '__main__':
    ...
    [train_data, train_y] = _import_data(train_file_path, 872)
    [test_data, test_y] = _import_data(test_file_path, 500)

    #if sys.argv[1] == "standard":
    print("Standard Algorithm")
    _run_standard_algorithm(learning_rate)

    print("Voted Algorithm")
    #elif sys.argv[1] == "voted":
    _run_voted_algorithm(learning_rate)

    print("Average Algorithm")
    #elif sys.argv[1] == "avg":
    _run_average_algorithm(learning_rate)
