...
if __name__ == '__main__':
    ...
    file_path1 = os.path.abspath('./Ensemble Learning/bank/train.csv')
    file_path2 = os.path.abspath('./Ensemble Learning/bank/train.csv')
    banktraindata = pd.read_csv(file_path1, names=columns_names, header=None)
    bank_test = pd.read_csv(file_path2, names=columns_names, header=None)
